...
class readAndConvert:
    ...
    def A_2_D(self,file_stem):
        ...
        if rr.raw_header["nbElts1D"] > 0: 
            ...
            "Partless beams exists so we have to generate a dummy one 1000000000"
        ...
        # Part arrays
        self._d3plot.arrays[ArrayType.part_ids]                     = readAndConvert.apply_sorter(_, part_ids_tracker)
